...
<html lang="pt-br" dir="ltr">
	<head>
		<title>AVAGPI - painel de controle</title>
		<meta charset="utf-8">
		<!-- Stylesheets -->
	...
	<body>
		...
		<div id="top-bar">
			<div class="page-full-width cf">
				<ul id="nav" class="fl">
					<li class="v-sep"><a href="./" class="round button dark ic-left-arrow image-left">P&aacute;gina inicial</a></li>
					<li class="v-sep"><a class="round button dark menu-user image-left"><?php echo $_SESSION['email']; ?></a></li>
					<li><a href="logout.php" class="round button dark menu-logoff image-left">Logout</a></li>
				</ul> <!-- end nav -->
			</div> <!-- end full-width -->
		</div> <!-- end top-bar -->
		<!-- HEADER -->
		<div id="header-with-tabs">
			<div class="page-full-width cf">
				<ul id="tabs" class="fl">
					<li><a href="dashboard.php" class="active-tab dashboard-tab">Painel de controle</a></li>
				</ul> <!-- end tabs -->
				<!-- Change this image to your own company's logo -->
				<!-- The logo will automatically be resized to 30px height. -->
				<a href="./" id="company-branding-small" class="fr"><img src="<?php echo LOGO_PEQUENA ?>" alt="APRENDE" /></a>
			</div> <!-- end full-width -->	
		</div> <!-- end header -->
		<!-- MAIN CONTENT -->
		<div id="content">
					...
					<div class="half-size-column fl">
						<div class="content-module">
							...
							<div class="content-module-main">
								...
								itâ€™s contents.</div>
								<div class="error-box round">This is an error box. It will also resize based on itâ€™s 
								contents.</div>
